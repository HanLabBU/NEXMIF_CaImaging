...
%                             c_sig = [c_sig;y_AllMat(y_AllMat>y_ThreshMat_pos & (y_close == 0) & y_AllMat >0)];
                              ...
                              corrStatsTable{row,sp+10} = mean(y_AllMat((y_AllMat-y_ThreshMat_pos >1e-5) & (y_close == 0)));
...
% 
% saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball',sprintf('PDF %s - %s - speedwise - %s.fig',corrNames{corrTypeId},'Ball', corrDir{ccc})))
% saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball',sprintf('PDF %s - %s - speedwise - %s.png',corrNames{corrTypeId},'Ball', corrDir{ccc})))
% saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball',sprintf('PDF %s - %s - speedwise - %s.epsc',corrNames{corrTypeId},'Ball', corrDir{ccc})))
...
saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Sessionwise %s - %s - speedwise - %s.fig',corrNames{corrTypeId},'Ball', corrDir{ccc})))
saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Sessionwise %s - %s - speedwise - %s.png',corrNames{corrTypeId},'Ball', corrDir{ccc})))
saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Sessionwise %s - %s - speedwise - %s.epsc',corrNames{corrTypeId},'Ball', corrDir{ccc})))
...
%     text(0,mean(ylim)-0.1*diff(ylim),sprintf('Fisher sig left: p = %d',p_f_low_l),'HorizontalAlignment','center')
    ...
    saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Fisher test %s - %s - Low Speed - %s.fig',corrNames{corrTypeId},'Ball', corrDir{ccc} )))
    saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Fisher test %s - %s - Low Speed - %s.png',corrNames{corrTypeId},'Ball', corrDir{ccc} )))
    saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Fisher test %s - %s - Low Speed - %s.epsc',corrNames{corrTypeId},'Ball', corrDir{ccc} )))
...
saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Fisher test %s - %s - High Speed - %s.fig',corrNames{corrTypeId},'Ball', corrDir{ccc} )))
saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Fisher test %s - %s - High Speed - %s.png',corrNames{corrTypeId},'Ball', corrDir{ccc} )))
saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\e0_correlation_analysis_ball\8.3.22',sprintf('Fisher test %s - %s - High Speed - %s.epsc',corrNames{corrTypeId},'Ball', corrDir{ccc} )))
