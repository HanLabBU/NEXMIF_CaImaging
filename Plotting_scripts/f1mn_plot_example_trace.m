...
figure()
imagesc(traceMat)
set(gca,'Units','inches','InnerPosition',[0.3 0.3 4 3],'XTick',[],'Color','none','Box','off');
colormap('jet')
caxis([0 1])
colorbar('Box','off','TickDirection','out','TickLength',0.03,'LineWidth',2)
saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\Reviews_08_23\Codes\plots\pdfs\',sprintf('Fig1_full_heatmap-%s-%d.pdf',mouseID,day)))


% saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\a0_fig1_traces\',sprintf('full_heatmap-%s-%d.png',mouseID,day)))
% saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\a0_fig1_traces\',sprintf('full_heatmap-%s-%d.fig',mouseID,day)))
% saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\a0_fig1_traces\',sprintf('full_heatmap-%s-%d.epsc',mouseID,day)))
...
set(gca,'Units','inches','InnerPosition',[0.3 0.3 4 1],'TickDir','out','LineWidth',1,'Color','none','Box','off');
saveas(gcf,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\Reviews_08_23\Codes\plots\pdfs\',sprintf('Fig1_speed-%s-%d.pdf',mouseID,day)))
...
saveas(fig2,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\a0_fig1_traces\',sprintf('speed-%s-%d.png',mouseID,day)))
saveas(fig2,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\a0_fig1_traces\',sprintf('speed-%s-%d.fig',mouseID,day)))
saveas(fig2,fullfile('U:\eng_research_handata\Athif Mohamed\nexmif_paper\code_final\plots\a0_fig1_traces\',sprintf('speed-%s-%d.epsc',mouseID,day)))
